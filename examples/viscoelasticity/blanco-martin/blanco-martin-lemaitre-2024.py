...
def plot_simulation_data(ax):
  # Read data from file
  t, stress, strain = np.loadtxt("blanco-martin-lemaitre-2024_csv.csv", delimiter=',', skiprows=1, usecols=[0, 6, 5], unpack=True)
...
if __name__ == "__main__":
  ...
  axes[0].set_title(r"Modified Lemaitre model (Blanco-Martìn et al., 2024)")
  axes[1].legend(loc="lower right")

  # plt.show()
  fig.savefig("blanco-martin-lemaitre-2024.png", format="PNG", dpi=300, bbox_inches="tight")
